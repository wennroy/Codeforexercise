...
for x=1:row
    for y=1:col
        if showfield(x,y)==0||showfield(x,y)==-1...
        ||showfield(x,y)==-2
            continue
        end
        for i=x-1:x+1
...
for x=1:row
    for y=1:col
        if showfield(x,y)==0||showfield(x,y)==-1...
        ||showfield(x,y)==-2||showfield(x,y)~=knownmine(x,y)
            continue
        end
            for i=x-1:x+1
                for j=y-1:y+1
                    ...
                    showfield=shownum(i,j,minefield...
                    ,minenum,showfield,row,col);
                end
            end
    end
end
...
for x=1:row
    for y=1:col
        ...
        if Instruct==1
            showfield=shownum(x,y,minefield,minenum...
            ,showfield,row,col);
        end
    end
end
...
showfield=shownum(G(r,1),G(r,2),minefield,minenum...
,showfield,row,col);
